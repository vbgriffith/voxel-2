...
class Engine {
    constructor() {
        ...
        // Systems registry — open-ended; any system can register
        this.systems = {
            particle:    null,
            audio:       null,
            collision:   null,
    ...
    setupCamera() {
        ...
        // Do NOT attach manual controls — CameraController owns this
        // this.camera.attachControl(this.canvas, false);
        this.camera.lowerRadiusLimit = 25;
        this.camera.upperRadiusLimit = 50;
        this.camera.lowerBetaLimit   = Math.PI / 6;
        this.camera.upperBetaLimit   = Math.PI / 2.2;
        this.camera.inertia = 0.0;   // immediate follow
    ...
    registerSystem(name, system) {
        // Accept any system name — open-ended registry
